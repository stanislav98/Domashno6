...
namespace Anketa
{
    public partial class Form1 : Form
    {
        ...
        int sum_ch1 = 0; int sum_ch2 = 0; int sum_ch3 = 0;
    ...
    private void Form1_Load(object sender, EventArgs e)
        {
            ...
            comboBox1.Items.AddRange(new string[] { "Английски език", "Web дизайн", "Офис програмиране", "Базово програмиране", "Синтез и анализ" });
            comboBox2.Items.AddRange(new string[] { "Английски език", "Web дизайн", "Офис програмиране", "Базово програмиране", "Синтез и анализ" });
            comboBox3.Items.AddRange(new string[] { "Английски език", "Web дизайн", "Офис програмиране", "Базово програмиране", "Синтез и анализ" });
            comboBox4.Items.AddRange(new string[] { "Английски език", "Web дизайн", "Офис програмиране", "Базово програмиране", "Синтез и анализ" });
            comboBox5.Items.AddRange(new string[] { "Английски език", "Web дизайн", "Офис програмиране", "Базово програмиране", "Синтез и анализ" });

            label7.Text = "2) Интересът към дисциплината е свързан с";

            checkedListBox1.Items.AddRange(new string[] { "Бъдеща професионална реализация","Придобиване на опит", "Личност на преподавателя", "Друго"});
